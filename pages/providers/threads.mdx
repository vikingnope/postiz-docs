...
* Set the redirect URL to `https://postiz.example.com/integrations/social/threads` if you are running Postiz on `postiz.example.com`, or `http://localhost:4200/integrations/social/threads` if you are running on `localhost:4200`.
